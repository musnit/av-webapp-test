...
-->
  ...
  <xsl:template name ="trame">
    ...
    <div class="BRAentete">
         <h1>
            Avalanche hazard bulletin
          </h1>
      <h4>
        (valid outside marked/open runs)
      </h4>
      <h1>
      ...
      <h4>
        <xsl:text disable-output-escaping="yes">issued on </xsl:text>
      ...
      <xsl:if test="@AMENDEMENT='true'">
        ...
        <h2>
				Risk estimate for <span id="date-validite">
          <xsl:call-template name="DateLong">
    ...
    <!-- Entete seconde rubrique stabilite-->
      <h2>
        Snowpack stability until
          <xsl:call-template name="DateLong">
            <xsl:with-param name="date-heure" select="@DATEECHEANCE"/>
            <xsl:with-param name="avecAnnee" select="string('non')"/>
          </xsl:call-template>
          <xsl:text disable-output-escaping="yes"> in the evening</xsl:text>
 ...
 <!--         <xsl:apply-templates select="METEO"/>-->
		...
		<xsl:attribute name ="alt">Snow depth chart</xsl:attribute>
		</img>
      ...
      <div class="row avec3cols">
        ...
        <div class="col1">
            <h2>Off-piste snow depth</h2>
		<img>
		<xsl:attribute name="src">
		<xsl:value-of select="$urlBlob"/>
		<xsl:value-of select="ENNEIGEMENT/ImageSnow depth"/>
		</xsl:attribute>
		...
		<xsl:attribute name ="alt">Fresh snow chart</xsl:attribute>
		</img>
  ...
  <xsl:template match="CARTOUCHERISQUE">
	...
	<!--	</div>
      ...
      <p class="legende">Danger levels: 5 very high - 4 high - 3 considerable - 2 moderate - 1 low   --  En noir : les pentes les plus dangereuses</p>
</div>
				</div>
<div class="col2">
      <!--catouche-->
  ...
  <!-- Rubrique Snow depth (image)-->
  <xsl:template match="ENNEIGEMENT">
    <img>
      <xsl:attribute name="src">
        <xsl:text>data:image/</xsl:text>
        <xsl:value-of select="ImageSnow depth/@Format"/>
        <xsl:text>;base64,</xsl:text>
        <xsl:value-of select="ImageSnow depth/Content"/>
      </xsl:attribute>
      <xsl:attribute name="height">
        <xsl:value-of select="ImageSnow depth/@Height"/>
      </xsl:attribute>
      <xsl:attribute name="width">
        <xsl:value-of select="ImageSnow depth/@Width"/>
      </xsl:attribute>
      <xsl:attribute name="alt">
        <xsl:text>Snow depth</xsl:text>
      </xsl:attribute>
    </img>
  </xsl:template>
    ...
    <div id="BSH_graph" style="background-image: url({$CheminPicto}fond_BSH.png); background-repeat:no-repeat;">
      ...
      <div>
        <img>
          ...
          <xsl:attribute name="alt">
            <xsl:text>Freezing level and rain/snow line</xsl:text>
          </xsl:attribute>
        </img>
      </div>
      ...
      <div class="BSHtitreRisque">Avalanche danger</div>
      <div class="BSHrisque">
        <xsl:for-each select="RISQUES/RISQUE">
          <div>
            <img>
      ...
      <div id="BSHenneigements">
        <div  style="width:85px;" class="BSHtitreRisque">Snow depth</div>
        <ul>
        ...
        <div id="BSHenneigements_graph_alt1">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt1/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt1/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt1/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt1/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>Snow depth</xsl:text>
            </xsl:attribute>
        ...
        <div id="BSHenneigements_graph_alt2">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt2/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt2/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt2/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt2/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>Snow depth</xsl:text>
            </xsl:attribute>
        ...
        <div id="BSHenneigements_graph_alt3">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt3/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt3/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt3/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthAlt3/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>Snow depth</xsl:text>
            </xsl:attribute>
        ...
        <div id="BSHenneigements_graph_nord">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthNorth/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthNorth/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthNorth/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthNorth/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>North-facing snow depth</xsl:text>
            </xsl:attribute>
          </img>
        </div>
        <div id="BSHenneigements_graph_sud">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthSouth/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthSouth/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthSouth/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthSouth/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>South-facing snow depth</xsl:text>
            </xsl:attribute>
          </img>
        </div>
        <div id="BSHenneigements_graph_limite">
          <img>
            <xsl:attribute name="src">
              <xsl:text>data:image/</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthLimit/@Format"/>
              <xsl:text>;base64,</xsl:text>
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthLimit/Content"/>
            </xsl:attribute>
            <xsl:attribute name="height">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthLimit/@Height"/>
            </xsl:attribute>
            <xsl:attribute name="width">
              <xsl:value-of select="ENNEIGEMENTS/ImageSnow depthLimit/@Width"/>
            </xsl:attribute>
            <xsl:attribute name="alt">
              <xsl:text>South-facing snow depth</xsl:text>
            </xsl:attribute>
  ...
  <xsl:template match="BSH" mode="tableau">
    <div id="BSH_tableau">
      ...
      <ul class="BSH_iso_legende">
        ...
        <li>
          <img src="{$CheminPicto}lpn.png" alt="limite pluie neige"/> : Limit pluie neige (m)
        </li>
        <li>
      ...
      <div class="BSH_tableau_neige">
        <div class="BSH_tableau_titre_neige">
          ...
          <div>
            Snow depth à <xsl:value-of select="ENNEIGEMENTS/ENNEIGEMENT[1]/NIVEAU[2]/@ALTI" /> m
          </div>
        </div>
        <div class="BSHdate">
          <xsl:for-each select="RISQUES/RISQUE">
          ...
          <div class="BSH_tableau_neige_col">
            <xsl:for-each select="ENNEIGEMENTS/ENNEIGEMENT">
              <div>
                ...
                <strong>S : </strong>
                <xsl:choose>
                  <xsl:when test="@LimitSouth=-1">
                    <xsl:text>/</xsl:text>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="@LimitSouth"/> m
                  </xsl:otherwise>
                </xsl:choose>
                <br/>
                <strong>N : </strong>
                <xsl:choose>
                  <xsl:when test="@LimitNorth=-1">
                    <xsl:text>/</xsl:text>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="@LimitNorth"/> m
                  </xsl:otherwise>
                </xsl:choose>
              </div>
            </xsl:for-each>
