...
<style>html,body{margin:0;padding:0;background:#0b1324;color:#e2e8f0}body{padding:10px;font-family:-apple-system,system-ui,Segoe UI,Roboto,sans-serif;overflow-x:hidden}#status{font-size:13px;color:#94a3b8;margin-bottom:8px}#out img{max-width:100%;height:auto}#out .bloc1{display:flex !important;flex-direction:row !important;align-items:center;gap:10px;flex-wrap:nowrap}#out .risqueMaxi,#out .figurineRisque,#out .figurinePente{flex:0 0 auto}#out .risqueMaxi img{width:76px !important;height:76px !important;object-fit:contain}#out .figurineRisque img,#out .figurinePente img{max-height:120px !important;width:auto !important;object-fit:contain}#out .pictoSAT{width:28px !important;height:28px !important;vertical-align:middle}#out table img{max-height:28px !important;width:auto !important}#out .bloc2,#out .col1,#out .col2{overflow:hidden}#out pre{white-space:pre-wrap !important;word-break:break-word !important;overflow-wrap:anywhere !important;overflow:visible !important;max-width:100% !important;background:#0f172a !important;color:#e2e8f0 !important;border:1px solid #334155 !important;border-radius:10px !important;padding:10px !important;font-size:13px !important;line-height:1.4 !important}</style>
</head><body>
